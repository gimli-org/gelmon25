...
1. Filter and mask data
1. select 2D subsets
1. Invert single frames
1. Time-lapse inversion
1. Visualize results in 2D & 3D
1. Transfer to temperature
:::
::: {.column width="50%"}
...
## The salinity case (Dynadeep) - Temperature
![](images/dynadeep-samos.png)

## The salinity case - Salinity inversion
![](images/dynadeep-salinity.png)
