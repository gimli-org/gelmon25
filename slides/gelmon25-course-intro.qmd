...
- new **mesh functions**: `submesh()`, `extract2dUpperSurfaceMesh()`, `extract2dSlice()` 
...
- based on `TimelapseERT` with some extra function
...
## Timelapse ERT repository

{{< fa gift >}} collect published data sets and notebooks

|Name        |Reference            |dim  |time|data |Info             |
|------------|---------------------|---  |---:|----:|-----------------|
|pyGIMLi     |@Ruecker2017         |2D   |  10|  740|synthetic tracer |
|Hillslope   |@Huebner2015         |2D   |  24|  800|min. length      |
...
|TestUM      |Birnstengel et al. ()|3D xh|  70| 2200|heat experiment  |
|DynaDeep    |Skibbe et al. ()     |2D   |  10| 3000|topography change|
